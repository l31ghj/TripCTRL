        ...
        <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
          ...
          >
            <div>
              ...
              <select
                className="h-9 w-full rounded-lg border border-slate-200 bg-slate-50 px-2 text-sm outline-none ring-blue-500/50 focus:bg-white focus:ring"
              ...
              {segmentForm.type === 'transport' && (
                <div className="mt-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleSegmentFieldChange('transportMode', e.target.value)
                    }
                  >
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSegmentFieldChange('seatNumber', e.target.value)
                    }
                    placeholder="e.g. 32A"
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSegmentFieldChange('passengerName', e.target.value)
                    }
